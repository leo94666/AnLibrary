...
Java_com_top_plateocr_PlateRecognition_InitPlateRecognizer(
...
Java_com_top_plateocr_PlateRecognition_SimpleRecognization(
        JNIEnv *env, jclass obj,
...
Java_com_top_plateocr_PlateRecognition_PlateInfoRecognization(
        JNIEnv *env, jclass obj,
        jlong matPtr, jlong object_pr) {
    jclass plateInfo_class = env -> FindClass("com/top/plateocr/PlateInfo");
...
Java_com_top_plateocr_PlateRecognition_ReleasePlateRecognizer(
        JNIEnv *env, jclass obj,
        jlong object_re) {
