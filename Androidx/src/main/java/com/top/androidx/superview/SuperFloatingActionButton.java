...
public class SuperFloatingActionButton extends FloatingActionButton implements View.OnTouchListener {

    private String TAG = "SuperFloatingActionButton";
    private double mLastX, mLastY;
    private double mOriginX, mOriginY;

    private OnClickListener onClickListener;

    public SuperFloatingActionButton(@NonNull Context context) {
        super(context);
        initView();
    }


    public SuperFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();

    }

    public SuperFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
