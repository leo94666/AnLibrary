 ...
 * ELabMcAndroid
 * <p>
 * Created by 李阳 on 2020/9/8 0008
...
public class SuperCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.SuperCheckBox);
            mStrokeWidth = (int) array.getDimension(R.styleable.SuperCheckBox_stroke_width, dip(mStrokeWidth));
            mStrokeColor = array.getColor(R.styleable.SuperCheckBox_stroke_color, mStrokeColor);
            mCircleColor = array.getColor(R.styleable.SuperCheckBox_circle_color, Color.WHITE);
            defaultSize = (int) array.getInteger(R.styleable.SuperCheckBox_circle_size, defaultSize);
            mDuration = (int) array.getInteger(R.styleable.SuperCheckBox_anim_duration, mDuration);

            checked = array.getBoolean(R.styleable.SuperCheckBox_checked, false);
            array.recycle();
        } else {
    ...
    public interface OnCheckedChangeListener {
        void onChange(SuperCheckBox view, boolean checked);
    }
}