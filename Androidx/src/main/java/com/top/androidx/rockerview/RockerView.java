...
public class RockerView extends View {
    ...
    private static final float DEFAULT_ROCKER_SCALE = 0.3f;//默认半径为背景的0.3
    ...
    private OnClickRockerCenterListener mOnClickRockerCenterListener;
        ...
        setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (event.getX() - downX > offsetDistance || event.getY() - downY > offsetDistance) {

                    } else {
                        if (System.currentTimeMillis() - downTime < delayTime) {
                            if (mOnClickRockerCenterListener != null) {
                                mOnClickRockerCenterListener.onClickRocker();
                            }
                        }
                    }
                }
    ...
    private Point getRockerPositionPoint(Point centerPoint, Point touchPoint,
                                         float regionRadius, float rockerRadius) {
        // 两点在X轴的距离
     ...
     * @param listenr
     */
    public void setOnClickRockerCenterListener(OnClickRockerCenterListener listenr) {
        mOnClickRockerCenterListener = listenr;
    }
     ...
     * 点击摇杆回调
     */
    public interface OnClickRockerCenterListener {
        void onClickRocker();
    }
