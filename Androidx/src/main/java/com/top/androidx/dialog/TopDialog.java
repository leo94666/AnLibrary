package com.top.androidx.dialog;
...
public class TopDialog {
    ...
    public TopDialog builder() {
        ...
        dialog = new Dialog(mContext, R.style.TOP_AlertDialogStyle);
    ...
    public TopDialog setTitle(@NonNull String title) {
        showTitle = true;
        mTitleTv.setText(title);
        return this;
    }

    public TopDialog appendTitle(@NonNull String title) {
        showTitle = true;
    ...
    public TopDialog setTitleSize(@NonNull int title) {
        showTitle = true;
     ...
     * @return
     */
    public TopDialog setCancelable(boolean cancel) {
     ...
     * @return
     */
    public TopDialog setCancelOutside(boolean isCancelOutside) {
     ...
     * @return
     */
    public TopDialog setPositiveButton(String text,
    ...
    public TopDialog setPositiveButton(final OnClickListener listener) {
     ...
     * @return
     */
    public TopDialog setNegativeButton(String text,
                                       final OnClickListener listener) {
        showNegBtn = true;
    ...
    public TopDialog setNegativeButton(
            final OnClickListener listener) {
    ...
    public void show() {
        setLayout();
        if (unwrap(dialog.getContext()) != null) {
            if (!unwrap(dialog.getContext()).isFinishing()) {
                dialog.show();
            }
        }
    }
     ...
     * @return
     */
    public TopDialog setDialogWidth(float dialogWidth) {
