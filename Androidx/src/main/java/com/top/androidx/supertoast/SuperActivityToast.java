...
import com.top.androidx.supertoast.utils.ListenerUtils;
...
public class SuperActivityToast extends SuperToast {
     ...
     *
     * @see #setOnButtonClickListener(String, Parcelable,
     ...
     *
     * This should be called in the {@link Activity#onSaveInstanceState(Bundle)}
