...
public class GenerateDimens {
    ...
    private static String resDir="../../../../../main/res";
...
//    }
    ...
    private static void startGenerate() {
        ...
        File rootFile =  new File(resDir+"/values/dimens.xml");
        ...
        try {
            ...
            File file360 = new File(resDir+"/values-w360dp");
            file360.mkdir();
            File file390 = new File(resDir+"/values-w390dp");
            file390.mkdir();
            File file410 = new File(resDir+"/values-w410dp");
            file410.mkdir();
        ...
        String w360dpFilePath = resDir+"/values-w360dp/dimens.xml";
        String w390dpFilePath = resDir+"/values-w390dp/dimens.xml";
        String w410dpFilePath = resDir+"/values-w410dp/dimens.xml";
     ...
     */
    @Test
    public void generateStandardFile_360dp() throws IOException {
        System.out.println("generate ---> start");
        File rootFile =  new File(resDir+"/values/dimens.xml");
        ...
        bufferedWriter.write("\t<!-- From GenerateDimens.class -->");
        bufferedWriter.newLine();
