...
public final class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return UtilsBridge.deleteAllInDir(AnUtils.getApp().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return UtilsBridge.deleteAllInDir(AnUtils.getApp().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return UtilsBridge.deleteAllInDir(new File(AnUtils.getApp().getFilesDir().getParent(), "databases"));
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return AnUtils.getApp().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSp() {
        return UtilsBridge.deleteAllInDir(new File(AnUtils.getApp().getFilesDir().getParent(), "shared_prefs"));
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && UtilsBridge.deleteAllInDir(AnUtils.getApp().getExternalCacheDir());
    }
