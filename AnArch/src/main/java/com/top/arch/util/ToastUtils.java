...
public final class ToastUtils {
    ...
    public final ToastUtils setLeftIcon(@DrawableRes int resId) {
        return setLeftIcon(ContextCompat.getDrawable(AnUtils.getApp(), resId));
    }
    ...
    public final ToastUtils setTopIcon(@DrawableRes int resId) {
        return setTopIcon(ContextCompat.getDrawable(AnUtils.getApp(), resId));
    }
    ...
    public final ToastUtils setRightIcon(@DrawableRes int resId) {
        return setRightIcon(ContextCompat.getDrawable(AnUtils.getApp(), resId));
    }
    ...
    public final ToastUtils setBottomIcon(int resId) {
        return setBottomIcon(ContextCompat.getDrawable(AnUtils.getApp(), resId));
    }
    ...
    private static IToast newToast(ToastUtils toastUtils) {
        if (!toastUtils.isNotUseSystemToast) {
            if (NotificationManagerCompat.from(AnUtils.getApp()).areNotificationsEnabled()) {
    ...
    static final class WindowManagerToast extends AbsToast {
        ...
        private AnUtils.ActivityLifecycleCallbacks mActivityLifecycleCallbacks;
        ...
        public void show(final int duration) {
            ...
            mParams.packageName = AnUtils.getApp().getPackageName();
            ...
            mWM = (WindowManager) AnUtils.getApp().getSystemService(Context.WINDOW_SERVICE);
            try {
                if (mWM != null) {
    ...
    static final class ActivityToast extends AbsToast {
        ...
        private View getToastViewSnapshot(final int index) {
            ...
            ImageView toastIv = new ImageView(AnUtils.getApp());
        ...
        private void registerLifecycleCallback() {
            ...
            mActivityLifecycleCallbacks = new AnUtils.ActivityLifecycleCallbacks() {
                @Override
    ...
    static abstract class AbsToast implements IToast {
        ...
        AbsToast(ToastUtils toastUtils) {
            mToast = new Toast(AnUtils.getApp());
