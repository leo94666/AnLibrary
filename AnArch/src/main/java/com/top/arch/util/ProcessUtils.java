...
public final class ProcessUtils {
    ...
    public static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) AnUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(AnUtils.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) AnUtils.getApp().getSystemService(Context.APP_OPS_SERVICE);
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) AnUtils.getApp()
    ...
    public static boolean isMainProcess() {
        return AnUtils.getApp().getPackageName().equals(getCurrentProcessName());
    }
    ...
    private static String getCurrentProcessNameByReflect() {
        String processName = "";
        try {
            Application app = AnUtils.getApp();
