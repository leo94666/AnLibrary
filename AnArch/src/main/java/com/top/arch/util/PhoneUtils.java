...
public final class PhoneUtils {
    ...
    public static void dial(final String phoneNumber) {
        AnUtils.getApp().startActivity(UtilsBridge.getDialIntent(phoneNumber));
    }
    ...
    public static void call(final String phoneNumber) {
        AnUtils.getApp().startActivity(UtilsBridge.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        AnUtils.getApp().startActivity(UtilsBridge.getSendSmsIntent(phoneNumber, content));
    }

    private static TelephonyManager getTelephonyManager() {
        return (TelephonyManager) AnUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    }
}
