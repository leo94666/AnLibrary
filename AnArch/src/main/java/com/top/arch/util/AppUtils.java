...
public final class AppUtils {
     ...
     */
    public static void registerAppStatusChangedListener(@NonNull final AnUtils.OnAppStatusChangedListener listener) {
     ...
     * @param listener The status of application changed listener
     */
    public static void unregisterAppStatusChangedListener(@NonNull final AnUtils.OnAppStatusChangedListener listener) {
    ...
    public static void installApp(final File file) {
        ...
        AnUtils.getApp().startActivity(installAppIntent);
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        AnUtils.getApp().startActivity(UtilsBridge.getUninstallAppIntent(packageName));
    }
    ...
    public static boolean isAppInstalled(final String pkgName) {
        ...
        PackageManager pm = AnUtils.getApp().getPackageManager();
        try {
    ...
    public static boolean isAppDebug() {
        return isAppDebug(AnUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug(final String packageName) {
        ...
        ApplicationInfo ai = AnUtils.getApp().getApplicationInfo();
    ...
    public static boolean isAppSystem() {
        return isAppSystem(AnUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppRunning(final String pkgName) {
        ...
        ApplicationInfo ai = AnUtils.getApp().getApplicationInfo();
        int uid = ai.uid;
        ActivityManager am = (ActivityManager) AnUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        if (am != null) {
    ...
    public static void launchApp(final String packageName) {
        ...
        AnUtils.getApp().startActivity(launchAppIntent);
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        Intent intent = UtilsBridge.getLaunchAppIntent(AnUtils.getApp().getPackageName());
        if (intent == null) {
            Log.e("AppUtils", "Didn't exist launcher activity.");
            return;
        }
        ...
        AnUtils.getApp().startActivity(intent);
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(AnUtils.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final Activity activity, final int requestCode) {
        launchAppDetailsSettings(activity, requestCode, AnUtils.getApp().getPackageName());
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(AnUtils.getApp().getPackageName());
    }
    ...
    public static int getAppIconId() {
        return getAppIconId(AnUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return AnUtils.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(AnUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(AnUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(AnUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(AnUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignatures() {
        return getAppSignatures(AnUtils.getApp().getPackageName());
    }
    ...
    public static List<String> getAppSignaturesSHA1() {
        return getAppSignaturesSHA1(AnUtils.getApp().getPackageName());
    }
    ...
    public static List<String> getAppSignaturesSHA256() {
        return getAppSignaturesSHA256(AnUtils.getApp().getPackageName());
    }
    ...
    public static List<String> getAppSignaturesMD5() {
        return getAppSignaturesMD5(AnUtils.getApp().getPackageName());
    }
    ...
    public static int getAppUid() {
        return getAppUid(AnUtils.getApp().getPackageName());
    }
    ...
    public static int getAppUid(String pkgName) {
        try {
            return AnUtils.getApp().getPackageManager().getApplicationInfo(pkgName, 0).uid;
        } catch (Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(AnUtils.getApp().getPackageName());
    }
