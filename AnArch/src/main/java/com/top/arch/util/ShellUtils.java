...
public final class ShellUtils {
     ...
     * @return the task
     */
    public static AnUtils.Task<CommandResult> execCmdAsync(final String command,
                                                           final boolean isRooted,
                                                           final AnUtils.Consumer<CommandResult> consumer) {
     ...
     * @return the task
     */
    public static AnUtils.Task<CommandResult> execCmdAsync(final List<String> commands,
                                                           final boolean isRooted,
                                                           final AnUtils.Consumer<CommandResult> consumer) {
     ...
     * @return the task
     */
    public static AnUtils.Task<CommandResult> execCmdAsync(final String[] commands,
                                                           final boolean isRooted,
                                                           final AnUtils.Consumer<CommandResult> consumer) {
    ...
    public static AnUtils.Task<CommandResult> execCmdAsync(final String[] commands,
                                                           final boolean isRooted,
                                                           final boolean isNeedResultMsg,
                                                           @NonNull final AnUtils.Consumer<CommandResult> consumer) {
        return UtilsBridge.doAsync(new AnUtils.Task<CommandResult>(consumer) {
            @Override
