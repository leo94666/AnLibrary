...
public class NotificationUtils {
    ...
    public static boolean areNotificationsEnabled() {
        return NotificationManagerCompat.from(AnUtils.getApp()).areNotificationsEnabled();
    }
     ...
     */
    public static void notify(int id, AnUtils.Consumer<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer The consumer of create the builder of notification.
     */
    public static void notify(String tag, int id, AnUtils.Consumer<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer      The consumer of create the builder of notification.
     */
    public static void notify(int id, ChannelConfig channelConfig, AnUtils.Consumer<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer      The consumer of create the builder of notification.
     */
    public static void notify(String tag, int id, ChannelConfig channelConfig, AnUtils.Consumer<NotificationCompat.Builder> consumer) {
        NotificationManagerCompat.from(AnUtils.getApp()).notify(tag, id, getNotification(channelConfig, consumer));
    }


    public static Notification getNotification(ChannelConfig channelConfig, AnUtils.Consumer<NotificationCompat.Builder> consumer) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationManager nm = (NotificationManager) AnUtils.getApp().getSystemService(Context.NOTIFICATION_SERVICE);
            //noinspection ConstantConditions
            nm.createNotificationChannel(channelConfig.getNotificationChannel());
        }

        NotificationCompat.Builder builder = new NotificationCompat.Builder(AnUtils.getApp());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    public static void cancel(String tag, final int id) {
        NotificationManagerCompat.from(AnUtils.getApp()).cancel(tag, id);
    }
    ...
    public static void cancel(final int id) {
        NotificationManagerCompat.from(AnUtils.getApp()).cancel(id);
    }
    ...
    public static void cancelAll() {
        NotificationManagerCompat.from(AnUtils.getApp()).cancelAll();
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = AnUtils.getApp().getSystemService("statusbar");
    ...
    public static class ChannelConfig {
        ...
        public static final ChannelConfig DEFAULT_CHANNEL_CONFIG = new ChannelConfig(
                AnUtils.getApp().getPackageName(), AnUtils.getApp().getPackageName(), IMPORTANCE_DEFAULT
        );
