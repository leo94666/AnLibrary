...
public final class PathUtils {
    ...
    public static String getInternalAppDataPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            return AnUtils.getApp().getApplicationInfo().dataDir;
        }
        return getAbsolutePath(AnUtils.getApp().getDataDir());
    }
    ...
    public static String getInternalAppCodeCacheDir() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return AnUtils.getApp().getApplicationInfo().dataDir + "/code_cache";
        }
        return getAbsolutePath(AnUtils.getApp().getCodeCacheDir());
    }
    ...
    public static String getInternalAppCachePath() {
        return getAbsolutePath(AnUtils.getApp().getCacheDir());
    }
    ...
    public static String getInternalAppDbsPath() {
        return AnUtils.getApp().getApplicationInfo().dataDir + "/databases";
    }
    ...
    public static String getInternalAppDbPath(String name) {
        return getAbsolutePath(AnUtils.getApp().getDatabasePath(name));
    }
    ...
    public static String getInternalAppFilesPath() {
        return getAbsolutePath(AnUtils.getApp().getFilesDir());
    }
    ...
    public static String getInternalAppSpPath() {
        return AnUtils.getApp().getApplicationInfo().dataDir + "/shared_prefs";
    }
    ...
    public static String getInternalAppNoBackupFilesPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return AnUtils.getApp().getApplicationInfo().dataDir + "/no_backup";
        }
        return getAbsolutePath(AnUtils.getApp().getNoBackupFilesDir());
    }
    ...
    public static String getExternalAppDataPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        File externalCacheDir = AnUtils.getApp().getExternalCacheDir();
    ...
    public static String getExternalAppCachePath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getExternalCacheDir());
    }
    ...
    public static String getExternalAppFilesPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(null));
    }
    ...
    public static String getExternalAppMusicPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getExternalAppPodcastsPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getExternalAppRingtonesPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static String getExternalAppAlarmsPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getExternalAppNotificationsPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getExternalAppPicturesPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getExternalAppMoviesPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getExternalAppDownloadPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getExternalAppDcimPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getExternalAppDocumentsPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(null)) + "/Documents";
        }
        return getAbsolutePath(AnUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS));
    }
    ...
    public static String getExternalAppObbPath() {
        if (!UtilsBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(AnUtils.getApp().getObbDir());
    }
