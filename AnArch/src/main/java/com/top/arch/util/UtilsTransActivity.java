...
public class UtilsTransActivity extends AppCompatActivity {
    ...
    public static void start(final AnUtils.Consumer<Intent> consumer,
    ...
    public static void start(final Activity activity,
                             final AnUtils.Consumer<Intent> consumer,
                             final TransActivityDelegate delegate) {
    ...
    protected static void start(final Activity activity,
        ...
        Intent starter = new Intent(AnUtils.getApp(), cls);
        ...
        if (activity == null) {
            ...
            AnUtils.getApp().startActivity(starter);
        } else {
