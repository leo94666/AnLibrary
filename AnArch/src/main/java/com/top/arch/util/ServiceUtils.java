...
public final class ServiceUtils {
    ...
    public static void startService(@NonNull final Class<?> cls) {
        startService(new Intent(AnUtils.getApp(), cls));
    }
    ...
    public static void startService(Intent intent) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                AnUtils.getApp().startForegroundService(intent);
            } else {
                AnUtils.getApp().startService(intent);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static boolean stopService(@NonNull final Class<?> cls) {
        return stopService(new Intent(AnUtils.getApp(), cls));
    }
    ...
    public static boolean stopService(@NonNull Intent intent) {
        try {
            return AnUtils.getApp().stopService(intent);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static void bindService(@NonNull final Class<?> cls,
                                   @NonNull final ServiceConnection conn,
                                   final int flags) {
        bindService(new Intent(AnUtils.getApp(), cls), conn, flags);
    }
    ...
    public static void bindService(@NonNull final Intent intent,
                                   ...
                                   final int flags) {
        try {
            AnUtils.getApp().bindService(intent, conn, flags);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void unbindService(@NonNull final ServiceConnection conn) {
        AnUtils.getApp().unbindService(conn);
    }
