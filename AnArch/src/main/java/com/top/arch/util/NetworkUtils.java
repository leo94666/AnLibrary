...
public final class NetworkUtils {
    ...
    public static AnUtils.Task<Boolean> isAvailableAsync(@NonNull final AnUtils.Consumer<Boolean> consumer) {
        return UtilsBridge.doAsync(new AnUtils.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByPingAsync(final AnUtils.Consumer<Boolean> consumer) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static AnUtils.Task<Boolean> isAvailableByPingAsync(final String ip,
                                                               @NonNull final AnUtils.Consumer<Boolean> consumer) {
        return UtilsBridge.doAsync(new AnUtils.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
            public Boolean doInBackground() {
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByDnsAsync(final AnUtils.Consumer<Boolean> consumer) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static AnUtils.Task isAvailableByDnsAsync(final String domain,
                                                     @NonNull final AnUtils.Consumer<Boolean> consumer) {
        return UtilsBridge.doAsync(new AnUtils.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) AnUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) AnUtils.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) AnUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
     ...
     */
    @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
    public static AnUtils.Task<Boolean> isWifiAvailableAsync(@NonNull final AnUtils.Consumer<Boolean> consumer) {
        return UtilsBridge.doAsync(new AnUtils.Task<Boolean>(consumer) {
            @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
            @Override
            public Boolean doInBackground() {
     ...
     * @return the task
     */
    public static AnUtils.Task<String> getIPAddressAsync(final boolean useIPv4,
                                                         @NonNull final AnUtils.Consumer<String> consumer) {
        return UtilsBridge.doAsync(new AnUtils.Task<String>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static AnUtils.Task<String> getDomainAddressAsync(final String domain,
                                                             @NonNull final AnUtils.Consumer<String> consumer) {
        return UtilsBridge.doAsync(new AnUtils.Task<String>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) AnUtils.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
    ...
    public static String getSSID() {
        WifiManager wm = (WifiManager) AnUtils.getApp().getApplicationContext().getSystemService(WIFI_SERVICE);
        if (wm == null) return "";
    ...
    public static WifiScanResults getWifiScanResult() {
        ...
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) AnUtils.getApp().getSystemService(WIFI_SERVICE);
    ...
    private static final Set<AnUtils.Consumer<WifiScanResults>> SCAN_RESULT_CONSUMERS = new CopyOnWriteArraySet<>();
    ...
    public static void addOnWifiChangedConsumer(final AnUtils.Consumer<WifiScanResults> consumer) {
        ...
        sScanWifiTimer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                UtilsBridge.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        for (AnUtils.Consumer<WifiScanResults> consumer : SCAN_RESULT_CONSUMERS) {
                            consumer.accept(sPreWifiScanResults);
                        }
                    }
                });
    ...
    public static void removeOnWifiChangedConsumer(final AnUtils.Consumer<WifiScanResults> consumer) {
        if (consumer == null) return;
        UtilsBridge.runOnUiThread(new Runnable() {
            @Override
            public void run() {
            ...
            UtilsBridge.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 0 && mListeners.size() == 1) {
                        ...
                        AnUtils.getApp().registerReceiver(NetworkChangedReceiver.getInstance(), intentFilter);
                    }
                }
            });
        }
            ...
            UtilsBridge.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 1 && mListeners.size() == 0) {
                        AnUtils.getApp().unregisterReceiver(NetworkChangedReceiver.getInstance());
                    }
                }
            });
        }
