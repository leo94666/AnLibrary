...
public final class ResourceUtils {
    ...
    public static Drawable getDrawable(@DrawableRes int id) {
        return ContextCompat.getDrawable(AnUtils.getApp(), id);
    }
    ...
    public static int getIdByName(String name) {
        return AnUtils.getApp().getResources().getIdentifier(name, "id", AnUtils.getApp().getPackageName());
    }
    ...
    public static int getStringIdByName(String name) {
        return AnUtils.getApp().getResources().getIdentifier(name, "string", AnUtils.getApp().getPackageName());
    }
    ...
    public static int getColorIdByName(String name) {
        return AnUtils.getApp().getResources().getIdentifier(name, "color", AnUtils.getApp().getPackageName());
    }
    ...
    public static int getDimenIdByName(String name) {
        return AnUtils.getApp().getResources().getIdentifier(name, "dimen", AnUtils.getApp().getPackageName());
    }
    ...
    public static int getDrawableIdByName(String name) {
        return AnUtils.getApp().getResources().getIdentifier(name, "drawable", AnUtils.getApp().getPackageName());
    }
    ...
    public static int getMipmapIdByName(String name) {
        return AnUtils.getApp().getResources().getIdentifier(name, "mipmap", AnUtils.getApp().getPackageName());
    }
    ...
    public static int getLayoutIdByName(String name) {
        return AnUtils.getApp().getResources().getIdentifier(name, "layout", AnUtils.getApp().getPackageName());
    }
    ...
    public static int getStyleIdByName(String name) {
        return AnUtils.getApp().getResources().getIdentifier(name, "style", AnUtils.getApp().getPackageName());
    }
    ...
    public static int getAnimIdByName(String name) {
        return AnUtils.getApp().getResources().getIdentifier(name, "anim", AnUtils.getApp().getPackageName());
    }
    ...
    public static int getMenuIdByName(String name) {
        return AnUtils.getApp().getResources().getIdentifier(name, "menu", AnUtils.getApp().getPackageName());
    }
    ...
    public static boolean copyFileFromAssets(final String assetsFilePath, final String destFilePath) {
        boolean res = true;
        try {
            String[] assets = AnUtils.getApp().getAssets().list(assetsFilePath);
            if (assets != null && assets.length > 0) {
                ...
                res = UtilsBridge.writeFileFromIS(
                        destFilePath,
                        AnUtils.getApp().getAssets().open(assetsFilePath)
                );
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static String readAssets2String(final String assetsFilePath, final String charsetName) {
        try {
            InputStream is = AnUtils.getApp().getAssets().open(assetsFilePath);
    ...
    public static List<String> readAssets2List(final String assetsPath,
        ...
        try {
            return UtilsBridge.inputStream2Lines(AnUtils.getApp().getResources().getAssets().open(assetsPath), charsetName);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static boolean copyFileFromRaw(@RawRes final int resId, final String destFilePath) {
        return UtilsBridge.writeFileFromIS(
                destFilePath,
                AnUtils.getApp().getResources().openRawResource(resId)
        );
    }
    ...
    public static String readRaw2String(@RawRes final int resId, final String charsetName) {
        InputStream is = AnUtils.getApp().getResources().openRawResource(resId);
        byte[] bytes = UtilsBridge.inputStream2Bytes(is);
    ...
    public static List<String> readRaw2List(@RawRes final int resId,
                                            final String charsetName) {
        return UtilsBridge.inputStream2Lines(AnUtils.getApp().getResources().openRawResource(resId), charsetName);
    }
}
