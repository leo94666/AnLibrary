...
import com.top.arch.util.constant.PermissionConstants;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(AnUtils.getApp().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(AnUtils.getApp(), permission);
    }
    ...
    public static boolean isGrantedWriteSettings() {
        return Settings.System.canWrite(AnUtils.getApp());
    }
    ...
    private static void startWriteSettingsActivity(final Activity activity, final int requestCode) {
        ...
        intent.setData(Uri.parse("package:" + AnUtils.getApp().getPackageName()));
    ...
    public static boolean isGrantedDrawOverlays() {
        return Settings.canDrawOverlays(AnUtils.getApp());
    }
    ...
    public static void launchAppDetailsSettings() {
        Intent intent = UtilsBridge.getLaunchAppDetailsSettingsIntent(AnUtils.getApp().getPackageName(), true);
    ...
    static final class PermissionActivityImpl extends UtilsTransActivity.TransActivityDelegate {
        ...
        public static void start(final int type) {
            UtilsTransActivity.start(new AnUtils.Consumer<Intent>() {
                @Override
