...
public final class BarUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = AnUtils.getApp().getResources();
    ...
    public static int getActionBarHeight() {
        ...
        if (AnUtils.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, AnUtils.getApp().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    public static int getNavBarHeight() {
        Resources res = AnUtils.getApp().getResources();
    ...
    public static boolean isNavBarVisible(@NonNull final Window window) {
        ...
        if (isVisible) {
            ...
            if (UtilsBridge.isSamsung()
                ...
                try {
                    return Settings.Global.getInt(AnUtils.getApp().getContentResolver(), "navigationbar_hide_bar_enabled") == 0;
    ...
    private static String getResNameById(int id) {
        try {
            return AnUtils.getApp().getResources().getResourceEntryName(id);
        } catch (Exception ignore) {
            return "";
        }
    }
    ...
    public static boolean isSupportNavBar() {
        ...
        boolean menu = ViewConfiguration.get(AnUtils.getApp()).hasPermanentMenuKey();
