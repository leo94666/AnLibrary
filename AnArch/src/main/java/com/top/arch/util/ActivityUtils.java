...
public final class ActivityUtils {
     ...
     */
    public static void addActivityLifecycleCallbacks(final AnUtils.ActivityLifecycleCallbacks callbacks) {
     ...
     * @param callbacks The callbacks.
     */
    public static void removeActivityLifecycleCallbacks(final AnUtils.ActivityLifecycleCallbacks callbacks) {
    ...
    public static void startActivityForResult(@NonNull final Fragment fragment,
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, null, AnUtils.getApp().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startActivityForResult(@NonNull final Bundle extras,
                                              ...
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, extras, AnUtils.getApp().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startLauncherActivity() {
        startLauncherActivity(AnUtils.getApp().getPackageName());
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(AnUtils.getApp().getPackageName());
    }
    ...
    public static List<String> getMainActivities() {
        return getMainActivities(AnUtils.getApp().getPackageName());
    }
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(AnUtils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(AnUtils.getApp(), clz));
    }
    ...
    private static Context getTopActivityOrApp() {
        if (UtilsBridge.isAppForeground()) {
            ...
            return topActivity == null ? AnUtils.getApp() : topActivity;
        } else {
            return AnUtils.getApp();
        }
    }
