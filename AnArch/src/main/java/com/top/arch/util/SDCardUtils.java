...
public final class SDCardUtils {
    ...
    public static List<SDCardInfo> getSDCardInfo() {
        ...
        StorageManager sm = (StorageManager) AnUtils.getApp().getSystemService(Context.STORAGE_SERVICE);
    ...
    public static class SDCardInfo {
        ...
        public String toString() {
            return "SDCardInfo {" +
                    ...
                    ", totalSize = " + Formatter.formatFileSize(AnUtils.getApp(), totalSize) +
                    ", availableSize = " + Formatter.formatFileSize(AnUtils.getApp(), availableSize) +
                    '}';
        }
    }
}
