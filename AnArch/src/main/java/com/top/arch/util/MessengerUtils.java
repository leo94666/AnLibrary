...
public class MessengerUtils {
    ...
    public static void register() {
        if (UtilsBridge.isMainProcess()) {
            ...
            startServiceCompat(new Intent(AnUtils.getApp(), ServerService.class));
            return;
        }
    ...
    public static void unregister() {
        if (UtilsBridge.isMainProcess()) {
            ...
            Intent intent = new Intent(AnUtils.getApp(), ServerService.class);
            AnUtils.getApp().stopService(intent);
        }
        if (sLocalClient != null) {
            sLocalClient.unbind();
        }
    ...
    static class Client {
        ...
        boolean bind() {
            if (TextUtils.isEmpty(mPkgName)) {
                Intent intent = new Intent(AnUtils.getApp(), ServerService.class);
                return AnUtils.getApp().bindService(intent, mConn, Context.BIND_AUTO_CREATE);
            }
        ...
        void unbind() {
            ...
            try {
                AnUtils.getApp().unbindService(mConn);
