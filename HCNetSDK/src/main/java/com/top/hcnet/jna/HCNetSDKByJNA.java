...
public interface HCNetSDKByJNA extends Library {
    ...
    public static class NET_DVR_ID_CARD_INFO_ALARM extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "struIDCardCfg", "dwMajor",
                    ...
                    "byRes2", "dwFingerPrintDataLen", "pFingerPrintData",
                    "dwCapturePicDataLen", "pCapturePicData", "byRes");
        }
    }
	...
	*/
    ...
    public static class tagNET_DVR_TIME_EX extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("wYear", "byMonth", "byDay", "byHour",
                    "byMinute", "bySecond", "byRes");
        }
    }
    ...
    public static class tagNET_DVR_VALID_PERIOD_CFG extends Structure {
        ...
        public tagNET_DVR_TIME_EX struBeginTime;
        public tagNET_DVR_TIME_EX struEndTime;
        public byte byRes2[] = new byte[32];

        protected List<String> getFieldOrder() {
            return Arrays.asList("byEnable", "byBeginTimeFlag",
                    "byEnableTimeFlag", "byTimeDurationNo", "struBeginTime",
                    "struEndTime", "byRes2");
        }
    ...
    public static class NET_DVR_CARD_CFG_V50 extends Structure {
        ...
        public tagNET_DVR_VALID_PERIOD_CFG struValid;
...
//		}
    ...
    public static class NET_DVR_ACS_EVENT_INFO extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byCardNo", "byCardType", "byWhiteListNo",
                    ...
                    "byType", "byMACAddr", "bySwipeCardType", "byRes2",
    ...
    public static class NET_DVR_ID_CARD_INFO extends Structure
    {
        ...
        protected List<String> getFieldOrder(){
        return Arrays.asList("dwSize","byName", "struBirth","byAddr",
        		"byIDNum","byIssuingAuthority", "struStartDate","struEndDate",
        		"byTermOfValidity","bySex", "byNation","byRes");
        }
    }
    */
    ...
    public static class NET_DVR_ID_CARD_INFO_ALARM extends Structure
    {
        ...
        public byte[]   byRes2 = new byte[2];
        public int  dwFingerPrintDataLen;
        public ByteByReference pFingerPrintData;
        public int  dwCapturePicDataLen;
        public ByteByReference pCapturePicData;
        public byte[]   byRes = new byte[188];
        ...
        @Override
        protected List<String> getFieldOrder(){
        return Arrays.asList("dwSize","struIDCardCfg", "dwMajor","dwMinor",
        		"struSwipeTime","byNetUser", "struRemoteHostAddr","dwCardReaderNo",
        		"dwDoorNo","dwPicDataLen", "pPicData","byCardType",
        		"byDeviceNo","byRes2", "dwFingerPrintDataLen","pFingerPrintData",
        		"dwCapturePicDataLen","pCapturePicData","byRes");
        }
    }
    */
...
//    }
    ...
    boolean NET_DVR_CapturePlaybackPictureBlock_New(int iRealHandle, byte[] pPicBuf, int dwPicSize, int lpSizeReturned);
    ...
    boolean NET_DVR_GetPlayBackOsdTime(int lUserID, NET_DVR_TIME struTime);

    boolean NET_DVR_SetConnectTime(int var1);

   // boolean NET_DVR_SetPlayDataCallBack_V40(int lPlayHandle, F fRealDataCall, Pointer pUser);

    int NET_DVR_StartVoiceCom_V30(int lUserID,  int var2, int bNeedCBNoEncData, VoiceDataCallBack voiceDataCallBack,Pointer pUser);

    int NET_DVR_GetFileByTime_V40(int lUserID, String path, NET_DVR_PLAYCOND net_dvr_playcond);
