...
#define FFMPEG_CONFIGURATION "--prefix=./android/armeabi-v7a --enable-small --disable-programs --disable-avdevice --disable-encoders --disable-muxers --disable-filters --enable-cross-compile --cross-prefix=/Users/liyang/Android/ndk/android-ndk-r17c/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --enable-shared --disable-static --sysroot=/Users/liyang/Android/ndk/android-ndk-r17c/platforms/android-21/arch-arm --extra-cflags='-isysroot /Users/liyang/Android/ndk/android-ndk-r17c/sysroot -isystem /Users/liyang/Android/ndk/android-ndk-r17c/sysroot/usr/include/arm-linux-androideabi -D__ANDROID_API__=21 -U_FILE_OFFSET_BITS -DANDROID -ffunction-sections -funwind-tables -fstack-protector-strong -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -mthumb -Wa,--noexecstack -Wformat -Werror=format-security -O0 -fPIC' --arch=arm --target-os=android"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "./android/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "./android/armeabi-v7a/share/ffmpeg"
