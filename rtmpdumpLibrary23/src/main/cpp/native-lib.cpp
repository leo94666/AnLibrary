...
Java_com_top_rtmpdump_push_PushStreamActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_top_rtmpdump_push_DerryPusher_native_1init(JNIEnv *env, jobject thiz) {
    // C++层的初始化工作而已
...
extern "C"
JNIEXPORT void JNICALL
Java_com_top_rtmpdump_push_DerryPusher_native_1start(JNIEnv *env, jobject thiz, jstring path_) {
    // 子线程  1.连接流媒体服务器， 2.发包
    if (isStart) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL
Java_com_top_rtmpdump_push_DerryPusher_native_1initVideoEncoder(JNIEnv *env, jobject thiz, jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_top_rtmpdump_push_DerryPusher_native_1pushVideo(JNIEnv *env, jobject thiz, jbyteArray data_) {
    // data == nv21数据  编码  加入队列
...
extern "C"
JNIEXPORT void JNICALL
Java_com_top_rtmpdump_push_DerryPusher_native_1initAudioEncoder(JNIEnv *env, jobject thiz,
...
Java_com_top_rtmpdump_push_DerryPusher_native_1getInputSamples(JNIEnv *env, jobject thiz) {
    if (audioChannel) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_top_rtmpdump_push_DerryPusher_native_1pushAudio(JNIEnv *env, jobject thiz, jbyteArray data_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_top_rtmpdump_push_DerryPusher_native_1stop(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_top_rtmpdump_push_DerryPusher_native_1release(JNIEnv *env, jobject thiz) {
    DELETE(videoChannel);
    DELETE(audioChannel);
}
